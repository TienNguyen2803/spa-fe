...
const GalleryPage = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', mb: 4, gap: 1 }}>
        {imageCategories.map((category) => (
          <Chip
            ...
            sx={{ 
              backgroundColor: selectedCategory === category.id ? '#8D6E63' : undefined,
              '&:hover': {
                backgroundColor: selectedCategory === category.id ? '#6D4C41' : undefined
              }
            }}
          />
        ))}
      ...
      {/* Reviews Section */}
      <Box sx={{ mt: 10, mb: 6 }}>
        <Typography variant="h3" sx={{ color: '#8D6E63', fontWeight: 'bold', mb: 4, textAlign: 'center' }}>
