...
const TopButton = styled(OuterCircle)({
...
const SocialButtons = () => {
  ...
  return (
    <FloatingContainer>
      ...
      <OuterCircle onClick={() => window.open('https://zalo.me/0938296337', '_blank')}>
        <InnerCircle>
          <Box component="span" sx={{ fontWeight: 'bold', fontSize: '18px' }}>Zalo</Box>
        </InnerCircle>
        <Ripple />
        <Ripple sx={{ animationDelay: '1s' }} />
        <Ripple sx={{ animationDelay: '2s' }} />
      ...
      <OuterCircle onClick={() => window.open('https://m.me/Tiemcotam.vn', '_blank')}>
        <InnerCircle>
          <MessageIcon />
        </InnerCircle>
        <Ripple />
